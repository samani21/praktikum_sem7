<div id="top" class="row mb-3">
    <div class="col">
        <h3>Pilih Buldan dan Tahun Penggajian</h3>
    </div>
</div>
        ...
        <form action="" method="post">
            <div class="card px-3">
                <div class="mb-3 mt-3">
                    ...
                    <select name="bulan_select" class="form-select" aria-label="default select example">
                ...
                <div class="mb-3">
                    ...
                    <select name="tahun_select" class="form-select">
                        <option value="Semua" selected>Semua</option>
                       <?php
