    ...
    <div class="col">
        <?php
            ...
            if(isset($_POST["simpan_button"])){
                ...
                $sudahAda = false;
                $chechSQL = "SELECT * FROM karyawan WHERE nik = '$nik'";
                $resultCheck = mysqli_query($connection, $chechSQL);
        ...
        <div class="card px-3 py-3">
            <form action="" method="post">
                ...
                <div class="mb-3 mt-3">
                    ...
                    <input type="date" class="form-control" id="tanggal_mulai" name="tanggal_mulai" placeholder="misal: 001" required>
                </div>
                <div class="mb-3 mt-3">
