...
<div id="pesan" class="row mb-3">
    <div class="col">
        <?php
            ...
            $tatap_cehecked = $row["status_karyawan"] == "TETAP" ? "checked" : "";
            $kontrak_cehecked = $row["status_karyawan"] == "KONTRAK" ? "checked" : "";
            $magang_cehecked = $row["status_karyawan"] == "MAGANG" ? "checked" : "";
            ?>
    </div>
</div>
    ...
    <div class="col">
        <div class="card px-3 py-3">
            ...
            <div class="mb-3 mt-3">
                ...
                <label for="" class="form_label">Status Karyawan</label>
                <div class="mb-3 mt-3">
                    <input type="radio" class="form-check-input" name="status_karyawan" id="TETAP" value="TETAP" <?php echo $tatap_cehecked?> required>
                    <label for="TETAP" class="form-check-label">
                        Tetap
                    </label>
                </div>
                <div class="mb-3 mt-3">
                    <input type="radio" class="form-check-input" name="status_karyawan" id="KONTRAK" value="KONTRAK" <?php echo $kontrak_cehecked?> required>
                    <label for="KONTRAKKONTRAK" class="form-check-label">
                        Kontrak
                    </label>
                </div>
                <div class="mb-3 mt-3">
                    <input type="radio" class="form-check-input" name="status_karyawan" id="MAGANG" value="MAGANG" <?php echo $magang_cehecked?> required>
                ...
                <div class="mb-3 mt-3">
                    ...
                    <?php
                        ...
                        if(mysqli_num_rows($result_bagian) == 0){
                            ?>
                             <div class="alert alert-light" role="alet">
                               Data kosong
                            </div>
                            <?php
                            return;
                        ...
                        ?>
                        <select name="bagian_id" class="form-select" aria-label="Default select example">
